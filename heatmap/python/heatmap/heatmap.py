...
def index():
    return """
    <h1>Mapa</h1>
    <img src="/get_map_image" alt="Mapa">
    """
...
def get_map_image():
    ...
    # Cria uma resposta com o arquivo de imagem
    response = make_response(send_file(image_stream, mimetype='image/png'))

    # Adiciona o cabeçalho Access-Control-Allow-Origin para permitir o acesso de qualquer origem
